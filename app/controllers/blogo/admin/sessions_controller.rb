  ...
  class SessionsController < BaseController
    ...
    def create
      ...
      if user && user.authenticate(params[:password])
        ...
        redirect_to blogo_admin_url, notice: I18n.translate('admin.logged_in')
      else
        flash.now.alert = I18n.translate('admin.login_fail')
        render "new"
      end
    end
    ...
    def destroy
      ...
      redirect_to blogo_admin_url, notice: I18n.translate('admin.logged_out')
    end
  end
end
